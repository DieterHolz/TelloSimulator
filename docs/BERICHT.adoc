:imagesdir: TelloSimulator/assets
...
[caption="Abbildung 2: "]
image::tello-simulator-network-diagram-different-host.png[width=500]
...
[caption="Abbildung 3: "]
image::tello-simulator-network-diagram-same-host.png[width=500]
